...
const parsedRRSI = computed(() => {
  if (props.rrsi >= -50) return 4;
  else if (props.rrsi >= -60) return 3;
  else if (props.rrsi >= -70) return 2;
  else if (props.rrsi >= -80) return 1;
  else return 0;
});
</script>
...
<template>
  ...
  >
    <svg
      ...
      height="16"
      viewBox="0 0 16 16"
      class="list-item-rrsi w-7 h-7 text-primary-300 dark:text-zinc-600"
    >
